...
export interface ApiPerkPerk extends Schema.CollectionType {
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::perk.perk', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::perk.perk', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
export interface ApiStatStat extends Schema.SingleType {
  ...
  attributes: {
    ...
    courses: Attribute.Integer;
    hoursOfContent: Attribute.Integer;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
